...
>![aws s3](https://github.com/MindMaze74/diplom-project/blob/main/img/11.png)
...
>Важно:
>доступ к графане и кибане предоставляется через admin/admin в демонстрационных целях на боевом кластере данные меняются
