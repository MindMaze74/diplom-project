...
- Сервисный аккаунт с авторизованным ключом (путь к ключу указан в `terraform.tfvars`).Шаблон [terraform.tfvars.example](https://github.com/MindMaze74/diplom-project/blob/main/terraform/terraform.tfvars.example)
