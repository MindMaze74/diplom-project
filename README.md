...
| Технология / Сервис | Версия / Тип | Назначение |
|---------------------|--------------|------------|
| **Terraform** | >= 1.0 | Создание инфраструктуры (сети, ВМ, Security Groups). |
| **Ansible** | >= 2.9 | Настройка ВМ: установка Docker, запуск контейнеров, настройка сервисов. |
| **Docker** | Latest | Контейнеризация всех приложений. |
| **Nginx (на Bastion)** | Latest | Балансировщик и прокси для сайта, Grafana, Kibana. |
| **Nginx (на web)** | Latest | Веб-сервер для статического сайта. |
| **Node Exporter** | Latest | Сбор системных метрик с веб-серверов. |
| **Nginx Log Exporter** | Latest | Сбор метрик доступа Nginx. |
| **Prometheus** | Latest | Сбор и хранение метрик мониторинга. |
| **Grafana** | Latest | Визуализация метрик. |
| **Elasticsearch** | 8.17.0 | Хранилище логов. |
| **Kibana** | 8.17.0 | Просмотр логов. |
| **Filebeat** | 7.17.20 | Сбор и отправка логов в Elasticsearch. |
| **Rsync** | – | Резервное копирование файлов (ежедневно, хранение 7 дней). |
| **Cron** | – | Планировщик задач для бэкапа. |
| **Yandex Cloud CLI** | Latest | Управление облачными ресурсами из командной строки. |
